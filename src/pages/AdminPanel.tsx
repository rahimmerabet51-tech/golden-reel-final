...
export default function AdminPanel() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.videoUrl.trim()) {
      showNotification('error', 'Please enter a Vimeo URL');
      return;
    }
    ...
    try {
      // Use Vimeo URL directly (no file upload needed)
      const finalUrl = formData.videoUrl.trim();
      const fileType: 'image' | 'video' = 'video';
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-black/50 border border-white/20 rounded-lg text-white placeholder-white/50 focus:border-primary focus:outline-none"
                    placeholder="Paste Vimeo Link here (e.g., https://vimeo.com/123456)"
                    required
                  />
                </div>
